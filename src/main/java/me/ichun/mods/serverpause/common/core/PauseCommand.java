    ...
    public static void register(CommandDispatcher<CommandSourceStack> dispatcher) {
        dispatcher.register(Commands.literal("pause").requires(p -> p.hasPermission(4))
                .executes(context -> {
                    ...
                    context.getSource().sendSuccess(new TranslatableComponent(ServerPause.eventHandlerServer.forcePause ? "commands.pause.unpausing" : "commands.pause.pausing"), true);
